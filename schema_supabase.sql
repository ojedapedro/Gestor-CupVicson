...
VALUES
  ('g0g0g0g0-0000-0000-0000-000000000001', 'f0f0f0f0-0000-0000-0000-000000000001',
...
VALUES
  ('h0h0h0h0-0000-0000-0000-000000000001', 'f0f0f0f0-0000-0000-0000-000000000001',
   '2017-05-15', 'LUNES',
   0, 0, 1335210.68, 0, 0,
   0, 0, 0, 0, 0,
...
VALUES
  ('i0i0i0i0-0000-0000-0000-000000000001', 'h0h0h0h0-0000-0000-0000-000000000001',
...
INSERT INTO productos_refri (id, nombre, codigo, categoria, precio, unidad) VALUES
  ('j0j0j0j0-0000-0000-0000-000000000001', 'JARRA DE JUGO', '1001', 'JUGOS', 20, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000002', 'CACHITO', '1002', 'PASAPALOS', 20, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000003', 'SUBAMARIBNOS GRANJEROS PAN CANILLA', '1003', 'PASAPALOS', 3500, 'KG'),
  ('j0j0j0j0-0000-0000-0000-000000000004', 'SANDWINCH', '1004', 'SANDWICHES', 2000, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000005', 'PASAPALOS/CROASANT', '1005', 'PASAPALOS', 2100, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000006', 'EMPANADA/PASTELITOS', '1006', 'PASAPALOS', 1000, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000007', 'DULCES PEQUEÑOS', '1007', 'DULCES', 1200, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000008', 'TERMO DE LECHE', '1008', 'CAFE', 4100, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000009', 'TERMO DE CAFÉ', '1009', 'CAFE', 4100, 'UND'),
  ('j0j0j0j0-0000-0000-0000-00000000000a', 'SANDWCH ESPECIAL', '1010', 'SANDWICHES', 2520, 'UND'),
  ('j0j0j0j0-0000-0000-0000-00000000000b', 'GATORADE', '1011', 'REFRESCOS', 2520, 'UND'),
  ('j0j0j0j0-0000-0000-0000-00000000000c', 'PASTA SECA', '1012', 'PASAPALOS', 12500, 'UND'),
  ('j0j0j0j0-0000-0000-0000-00000000000d', 'PASAPALOS HOJALDRES', '1013', 'PASAPALOS', 2100, 'UND'),
  ('j0j0j0j0-0000-0000-0000-00000000000e', 'JARRO DE JUGO', '1014', 'JUGOS', 5500, 'UND'),
  ('j0j0j0j0-0000-0000-0000-00000000000f', 'AGUA PEQUENA', '1015', 'REFRESCOS', 840, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000010', 'MESA DE PASAPALOS', '1016', 'PASAPALOS', 1500, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000011', 'MINI PASTELITOS VARIADOS', '1017', 'DULCES', 2000, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000012', 'TARTALETAS, DULICES GRANDES', '1018', 'DULCES', 1500, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000013', 'EREPAS RELLENAS', '1019', 'PASAPALOS', 3100, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000014', 'YOGURT CON CEREAL', '1020', 'DULCES', 1600, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000015', 'ENSALADAS DE FRUTAS', '1021', 'DULCES', 1690, 'UND'),
  ('j0j0j0j0-0000-0000-0000-000000000016', 'TEQUEÑOS (100 UNIDADES)', '1022', 'PASAPALOS', 1690, 'UND')
ON CONFLICT DO NOTHING;

-- 11. Proveedor (ejemplo: PROCESADORA DE CARNES FITCA)
INSERT INTO proveedores (id, nombre, rif, telefono, email, estado)
VALUES ('k0k0k0k0-0000-0000-0000-000000000001', 'PROCESADORA DE CARNES FITCA, C.A.', 'J-00000000-0', '0212-0000000', 'contacto@fitca.com', 'activo')
ON CONFLICT DO NOTHING;
...
VALUES
  ('l0l0l0l0-0000-0000-0000-000000000001', 'b0b0b0b0-0000-0000-0000-000000000001',
   1, '2017-05-04', 'k0k0k0k0-0000-0000-0000-000000000001',
   '00079211', NULL,
...
VALUES
  ('m0m0m0m0-0000-0000-0000-000000000001', 'h0h0h0h0-0000-0000-0000-000000000001',
   'j0j0j0j0-0000-0000-0000-000000000001', '2017-05-01', 20, 400),
  ('m0m0m0m0-0000-0000-0000-000000000002', 'h0h0h0h0-0000-0000-0000-000000000001',
   'j0j0j0j0-0000-0000-0000-000000000002', '2017-05-01', 20, 400)
ON CONFLICT DO NOTHING;
